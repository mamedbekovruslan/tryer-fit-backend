...
export class AddProfileFieldsToUser1766913344006 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        if (!existingColumns.includes('waist_circumference')) {
            await queryRunner.query(`ALTER TABLE "users" ADD "waist_circumference" DECIMAL(5,2)`);
        }
        if (!existingColumns.includes('chest_circumference')) {
            await queryRunner.query(`ALTER TABLE "users" ADD "chest_circumference" DECIMAL(5,2)`);
        }
        if (!existingColumns.includes('hip_circumference')) {
            await queryRunner.query(`ALTER TABLE "users" ADD "hip_circumference" DECIMAL(5,2)`);
        }
        if (!existingColumns.includes('arm_circumference')) {
            await queryRunner.query(`ALTER TABLE "users" ADD "arm_circumference" DECIMAL(5,2)`);
        }
        if (!existingColumns.includes('leg_circumference')) {
            await queryRunner.query(`ALTER TABLE "users" ADD "leg_circumference" DECIMAL(5,2)`);
        }
        if (!existingColumns.includes('fitness_goal')) {
            await queryRunner.query(`ALTER TABLE "users" ADD "fitness_goal" text CHECK ("fitness_goal" IN ('weight_loss', 'muscle_gain', 'endurance', 'flexibility', 'general_fitness'))`);
        }
        ...
        if (!existingColumns.includes('contraindications')) {
            await queryRunner.query(`ALTER TABLE "users" ADD "contraindications" text`);
        }
        ...
        if (!existingColumns.includes('training_experience')) {
            await queryRunner.query(`ALTER TABLE "users" ADD "training_experience" text`);
        }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "users" DROP COLUMN "training_experience"`);
        ...
        await queryRunner.query(`ALTER TABLE "users" DROP COLUMN "contraindications"`);
        await queryRunner.query(`ALTER TABLE "users" DROP COLUMN "expected_result"`);
        await queryRunner.query(`ALTER TABLE "users" DROP COLUMN "fitness_goal"`);
        await queryRunner.query(`ALTER TABLE "users" DROP COLUMN "leg_circumference"`);
        await queryRunner.query(`ALTER TABLE "users" DROP COLUMN "arm_circumference"`);
        await queryRunner.query(`ALTER TABLE "users" DROP COLUMN "hip_circumference"`);
        await queryRunner.query(`ALTER TABLE "users" DROP COLUMN "chest_circumference"`);
        await queryRunner.query(`ALTER TABLE "users" DROP COLUMN "waist_circumference"`);
    }
